                        ...
                        <div class="card-body">
                          <form class="row g-3">
                              ...
                              <div class="col-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $get_user_details['first_name'];?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label">Last Name</label>
                                <input type="text" class="form-control" value="<?php echo $get_user_details['last_name'];?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label">Email address</label>
                                <input type="text" class="form-control" value="<?php echo $get_user_details['email'];?>">
                             </div>
                             <div class="col-6">
                              <label class="form-label">Mobile Number</label>
                              <input type="text" class="form-control" value="<?php echo $get_user_details['mobile_number'];?>">
                            </div>
                          </form>
                        </div>
                      </div>
