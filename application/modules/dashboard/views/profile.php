...
echo Modules::run("base/header");
echo Modules::run("base/menu");
                ...
                <div class="card shadow-sm border-0">
                  <div class="card-body">
                      ...
                      <div class="card shadow-none border">
                        ...
                        <div class="card-body">
                          <?php 
                                                        $attributes = array('class' => 'row g-3','enctype'=>'multipart/form-data');
                                                        echo form_open('update_profile', $attributes); 
                                                    ?>
                          
                             <input type="text" class="form-control" name="user_id" value="<?php echo $get_user_details['user_id'];?>">
                              <div class="col-6">
                                <label class="form-label">First Name</label>
                                <input type="text" class="form-control" name="first_name" value="<?php echo $get_user_details['first_name'];?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label">Last Name</label>
                                <input type="text" class="form-control" name="last_name" value="<?php echo $get_user_details['last_name'];?>">
                            </div>
                            <div class="col-6">
                                <label class="form-label">Email address</label>
                                <input type="text" class="form-control" name="email" value="<?php echo $get_user_details['email'];?>">
                             </div>
                             <div class="col-6">
                              <label class="form-label">Mobile Number</label>
                              <input type="text" class="form-control" name="mobile_number" value="<?php echo $get_user_details['mobile_number'];?>">
                            </div>
                          </form>
                        </div>
                      </div>
