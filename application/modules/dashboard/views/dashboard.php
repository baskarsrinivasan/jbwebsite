...
$get_user_details= $this->mcommon->specific_row("user", array("user_id"=>$this->session->userdata('user_id')));
                      ...
                      <tbody>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/11.png" alt="">
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/07.png" alt="">
                              </div>
                              <div class="product-info">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/17.png" alt="">
                              </div>
                              <div class="product-info">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/04.png" alt="">
                              </div>
                              <div class="product-info">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/10.png" alt="">
                              </div>
                              <div class="product-info">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-3">
                              <div class="product-box border">
                                 <img src="<?php echo base_url();?>assets/images/products/12.png" alt="">
                              </div>
                              <div class="product-info">
